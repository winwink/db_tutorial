---
title: Part 4 - 我们的第一个测试(和bug)
date: 2017-09-03
---

我们已经有能力往我们的数据库里插入数据并读取数据了. 让我们花点时间来测试一下.

我将用[rspec](http://rspec.info/)来写测试, 因为我很熟悉它, 而且它的语法很易读.

我将定义一个很小的helper来发送一系列的命令到我们的数据库程序, 然后判断输出是否正确.
